...
def checar_colisiones():
    global colisionando
    #Si extremaDerecha > extremaIzquierdaObstaculo
    # y extremaIzquierda < extremaDerechaObstaculo
    # y extremoSuperiorCarrito > extremoInfereriorObstaculo
    # y extremoInferirorCarrito < extremoSuperiorObstaculo
...
#Cuando colisione el programa se para ("colisionando = False") descomentariar en caso de uso
#colisionando = False
